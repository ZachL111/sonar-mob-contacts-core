"""Regression checks for the sonar-mob-contacts-core casebook."""
...
from casebook.harness import assert_expected, sonar_mob_contacts_core_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(sonar_mob_contacts_core_summary(), assert_expected())
